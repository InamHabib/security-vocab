...
programBase
    ...
    .option("-f, --fileExtensionFilter <extension>", "file extension filter", ".jsonld")
    .action(function (_, cmd) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (!((_a = cmd) === null || _a === void 0 ? void 0 : _a.args[0])) {
                    programBase.help();
                    process.exit(0);
                }
                return [4 /*yield*/, utilities_1.lint((_b = cmd) === null || _b === void 0 ? void 0 : _b.args[0], cmd.recursive, cmd.fileExtensionFilter)];
            case 1:
                if (_c.sent()) {
                    process.exit(1);
                }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (utilities_1.isDirectory(file)) {
                    console.log("Supplied parameter is a directory not a file");
                    process.exit(0);
                }
                return [4 /*yield*/, utilities_1.processFile(file)];
            case 1:
                if (_a.sent()) {
                    process.exit(1);
                }
