 ...
 */
export declare const sign: (request: BbsSignRequest) => Uint8Array;
/**
 ...
 * @returns The raw signature value
 */
export declare const blsSign: (request: BlsBbsSignRequest) => Uint8Array;
/**
 ...
 */
export declare const verify: (request: BbsVerifyRequest) => BbsVerifyResult;
/**
 ...
 * @returns A result indicating if the signature was verified
 */
export declare const blsVerify: (request: BlsBbsVerifyRequest) => BbsVerifyResult;
/**
 ...
 */
export declare const createProof: (request: BbsCreateProofRequest) => Uint8Array;
/**
 ...
 * @returns The raw proof value
 */
export declare const blsCreateProof: (request: BbsCreateProofRequest) => Uint8Array;
/**
 ...
 */
export declare const verifyProof: (request: BbsVerifyProofRequest) => BbsVerifyResult;
/**
 ...
 * @returns A result indicating if the proof was verified
 */
export declare const blsVerifyProof: (request: BbsVerifyProofRequest) => BbsVerifyResult;
/**
 ...
 */
export declare const commitmentForBlindSignRequest: (request: BbsBlindSignContextRequest) => BbsBlindSignContext;
/**
 ...
 */
export declare const verifyBlindSignContext: (request: BbsVerifyBlindSignContextRequest) => boolean;
/**
 ...
 * @returns The raw signature value
 */
export declare const blindSign: (request: BbsBlindSignRequest) => Uint8Array;
