...
import { EdDSA, Ed25519KeyPair, keyUtils } from '@transmute/did-key-ed25519';
import { ES256K, Secp256k1KeyPair } from '@transmute/did-key-secp256k1';
import { createDetachedJws, privateKeyToSigner, publicKeyToVerifier, KeyPair } from '@transmute/did-key-web-crypto';
...
var orderJwk = function orderJwk(jwk) {
  var _jwk = {};
...
var didKeyToJsonWebKey = function didKeyToJsonWebKey(didKeyPair) {
  var json = didKeyPair.toJsonWebKeyPair(true);
  var publicKeyJwk = json.publicKeyJwk,
...
var didKeyGenerator = /*#__PURE__*/function () {
  var _ref = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(kty, crvOrSize, seed) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.t0 = didKeyToJsonWebKey;
            _context.next = 4;
          ...
          case 6:
            ...
            _context.t2 = didKeyToJsonWebKey;
            _context.next = 10;
          ...
          case 15:
            _context.t4 = didKeyToJsonWebKey;
            _context.next = 18;
          ...
          case 23:
            _context.t6 = didKeyToJsonWebKey;
            _context.next = 26;
            return KeyPair.generate({
              kty: kty,
              crvOrSize: crvOrSize
          ...
          case 26:
            ...
            return _context.abrupt("return", (0, _context.t6)(_context.t7));
          ...
          case 31:
            _context.t8 = didKeyToJsonWebKey;
            _context.next = 34;
            return KeyPair.generate({
              kty: kty,
              crvOrSize: crvOrSize
          ...
          case 34:
            ...
            return _context.abrupt("return", (0, _context.t8)(_context.t9));
  ...
  return function didKeyGenerator(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
var signWithDetachedJws = /*#__PURE__*/function () {
  var _ref2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(privateKeyJwk, message) {
    var signer, _signer, _signer2;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", EdDSA.signDetached(message, privateKeyJwk, {
              alg: 'EdDSA',
              b64: false,
              crit: ['b64']
            }));
          ...
          case 2:
            ...
            return _context2.abrupt("return", ES256K.signDetached(message, privateKeyJwk, {
              alg: 'ES256K',
              b64: false,
              crit: ['b64']
            }));
          ...
          case 7:
            ...
            return _context2.abrupt("return", createDetachedJws(signer, message, {
              alg: 'ES256',
              b64: false,
              crit: ['b64']
            }));
          ...
          case 12:
            _signer = _context2.sent;
            return _context2.abrupt("return", createDetachedJws(_signer, message, {
              alg: 'ES384',
              b64: false,
              crit: ['b64']
            }));
          ...
          case 17:
            _signer2 = _context2.sent;
            return _context2.abrupt("return", createDetachedJws(_signer2, message, {
              alg: 'ES521',
              b64: false,
              crit: ['b64']
            }));
          ...
          case 19:
            throw new Error("JsonWebKey2020 does not support sign with " + privateKeyJwk.crv);
  ...
  return function signWithDetachedJws(_x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
var verifyWithDetachedJws = /*#__PURE__*/function () {
  var _ref3 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3(publicKeyJwk, jws, message) {
    var verifier, _verifier, _verifier2;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return _context3.abrupt("return", EdDSA.verifyDetached(jws, message, publicKeyJwk));
          ...
          case 2:
            ...
            return _context3.abrupt("return", ES256K.verifyDetached(jws, message, publicKeyJwk));
          ...
          case 7:
            ...
            return _context3.abrupt("return", Jws.verifyDetachedJws(verifier, message, jws));
          ...
          case 12:
            _verifier = _context3.sent;
            return _context3.abrupt("return", Jws.verifyDetachedJws(_verifier, message, jws));
          ...
          case 17:
            _verifier2 = _context3.sent;
            return _context3.abrupt("return", Jws.verifyDetachedJws(_verifier2, message, jws));

          case 19:
            throw new Error("JsonWebKey2020 does not support verify with " + publicKeyJwk.crv);
  ...
  return function verifyWithDetachedJws(_x6, _x7, _x8) {
    return _ref3.apply(this, arguments);
  };
}();

var JsonWebKey = /*#__PURE__*/function () {
  function JsonWebKey(options) {
  ...
  JsonWebKey.generate = /*#__PURE__*/function () {
    var _generate = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(options) {
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.t0 = JsonWebKey;
              _context.next = 4;
              return didKeyGenerator(options.kty, options.crvOrSize, options.seed);
  ...
  JsonWebKey.from = /*#__PURE__*/function () {
    var _from = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(options) {
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              return _context2.abrupt("return", new JsonWebKey(options));
  ...
  var _proto = JsonWebKey.prototype;

  _proto.toLinkedDataKeyPair = function toLinkedDataKeyPair() {
    return {
      id: this.id,
      type: this.type,
  ...
  _proto.signer = function signer() {
    ...
    var privateKeyJwk = this.privateKeyJwk;
    return {
          ...
          return runtime_1.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  data = _ref.data;
                  return _context4.abrupt("return", signWithDetachedJws(privateKeyJwk, data));
  ...
  _proto.verifier = function verifier() {
    ...
    var publicKeyJwk = this.publicKeyJwk;
    return {
            ...
            while (1) {
              switch (_context6.prev = _context6.next) {
                case 0:
                  ...
                  _context6.prev = 2;
                  _context6.next = 5;
                  return verifyWithDetachedJws(publicKeyJwk, signature, data);

                case 5:
                  verified = _context6.sent;
                  _context6.next = 11;
                  break;
                ...
                case 8:
                  ...
                  console.error('An error occurred when verifying signature: ', _context6.t0);

                case 11:
                  return _context6.abrupt("return", verified);
...
var JsonWebSignature = /*#__PURE__*/function () {
  function JsonWebSignature(options) {
    ...
    this.type = 'https://w3id.org/security#JsonWebSignature2020';
  ...
  _proto.canonize = /*#__PURE__*/function () {
    var _canonize = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(input, _ref) {
      var documentLoader, expansionMap, skipExpansion;
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              documentLoader = _ref.documentLoader, expansionMap = _ref.expansionMap, skipExpansion = _ref.skipExpansion;
  ...
  _proto.canonizeProof = /*#__PURE__*/function () {
    var _canonizeProof = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(proof, _ref2) {
      var documentLoader, expansionMap;
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              documentLoader = _ref2.documentLoader, expansionMap = _ref2.expansionMap;
  ...
  _proto.createVerifyData = /*#__PURE__*/function () {
    var _createVerifyData = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3(_ref3) {
  ...
  _proto.matchProof = /*#__PURE__*/function () {
    var _matchProof = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee4(_ref4) {
      var proof;
      return runtime_1.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              proof = _ref4.proof;
              return _context4.abrupt("return", proof.type === 'sec:JsonWebSignature2020');
  ...
  _proto.updateProof = /*#__PURE__*/function () {
    var _updateProof = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee5(_ref5) {
      var proof;
      return runtime_1.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
  ...
  _proto.sign = /*#__PURE__*/function () {
    var _sign = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee6(_ref6) {
  ...
  _proto.createProof = /*#__PURE__*/function () {
    var _createProof = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee7(_ref7) {
  ...
  _proto.getVerificationMethod = /*#__PURE__*/function () {
    var _getVerificationMethod = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee8(_ref8) {
      var proof, documentLoader, verificationMethod, creator, result;
  ...
  _proto.verifySignature = /*#__PURE__*/function () {
    var _verifySignature = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee9(_ref9) {
      var verifyData, verificationMethod, proof, verifier, key;
          ...
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              if (!verificationMethod.publicKeyJwk) {
                console.warn('The current security context used by JSON-LD Signatures does not understand publicKeyJwk.');
                console.log(verificationMethod);
                verificationMethod.publicKeyJwk = verificationMethod['sec:publicKeyJwk']['@value'];
              ...
              _context9.next = 6;
              return JsonWebKey.from(verificationMethod);
  ...
  _proto.verifyProof = /*#__PURE__*/function () {
    var _verifyProof = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee10(_ref10) {
...
//# sourceMappingURL=json-web-signature-2020.esm.js.map
