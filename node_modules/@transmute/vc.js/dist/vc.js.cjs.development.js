...
var linkedDataProof = require('@transmute/linked-data-proof');
var jsonld$2 = _interopDefault(require('jsonld'));
...
var checkCredential = function checkCredential(credential, documentLoader) {
  try {
    ...
    return Promise.resolve(jsonldChecker.check(credential, documentLoader)).then(function (isValidJsonLd) {
      if (!isValidJsonLd.ok) {
...
var issue = function issue(options) {
  try {
    ...
    return Promise.resolve(checkCredential(credential, documentLoader)).then(function () {
      ...
      return linkedDataProof.sign(credential, _extends({
        purpose: purpose
      }, options));
    });
  } catch (e) {
...
var _verifyCredential = function _verifyCredential(options) {
  try {
    ...
    return Promise.resolve(checkCredential(credential, documentLoader)).then(function () {
      ...
      return Promise.resolve(linkedDataProof.verify(credential, _extends({
        purpose: purpose
...
var _verifyPresentation = function _verifyPresentation(options) {
  try {
    var _temp4 = function _temp4() {
      ...
      return Promise.resolve(linkedDataProof.verify(presentation, _extends({
        purpose: purpose
...
var signPresentation = function signPresentation(options) {
  ...
  try {
    ...
    return Promise.resolve(linkedDataProof.sign(presentation, _extends({
      purpose: purpose
    }, options)));
  } catch (e) {
    return Promise.reject(e);
