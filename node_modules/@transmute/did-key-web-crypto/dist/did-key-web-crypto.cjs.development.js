...
var createJws = didKeyCommon.Jws.createJws,
    createDetachedJws = didKeyCommon.Jws.createDetachedJws;
...
exports.KeyPair = KeyPair_1 = /*#__PURE__*/function () {
  ...
  KeyPair.generateEphemeralKeyPair = function generateEphemeralKeyPair(epkArgs) {
    try {
      return Promise.resolve(didKeyCipher.getEpkGenerator(KeyPair_1, epkArgs)());
    } catch (e) {
      return Promise.reject(e);
    }
  };
...
exports.KeyPair.JWE_ALG = 'ECDH-ES+A256KW';

exports.KeyPair.generate = function (options) {
  try {
...
exports.KeyPair.from = function (options) {
  return new KeyPair_1(_extends({}, options));
};

exports.KeyPair.fromFingerprint = function (_ref4) {
...
exports.KeyPair = KeyPair_1 = /*#__PURE__*/tslib.__decorate([/*#__PURE__*/staticImplements()], exports.KeyPair);

var resolve = /*#__PURE__*/didKeyCommon.getResolve(exports.KeyPair);
...
exports.createDetachedJws = createDetachedJws;
exports.createJws = createJws;
exports.deriveSecret = deriveSecret;
exports.driver = driver;
exports.privateKeyToSigner = privateKeyToSigner;
exports.publicKeyToVerifier = publicKeyToVerifier;
