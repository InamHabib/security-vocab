        ...
        sign: function (_ref) {
          ...
          try {
            ...
            return Promise.resolve(_this.key.toJsonWebKeyPair(true)).then(function (_ref2) {
              ...
              return Promise.resolve(didKeyEd25519.EdDSA.signDetached(payload, privateKeyJwk, header));
            });
          } catch (e) {
        ...
        verify: function (_ref3) {
          ...
          try {
            ...
            var _temp2 = _catch(function () {
              return Promise.resolve(didKeyEd25519.EdDSA.verifyDetached(signature, data, didKeyEd25519.keyUtils.publicKeyJwkFromPublicKeyBase58(_this2.key.publicKeyBase58))).then(function (_EdDSA$verifyDetached) {
  ...
  _proto.verifySignature = function verifySignature(_ref12) {
    ...
    try {
      ...
      var _temp10 = function () {
        if (!verifier) {
          return Promise.resolve(didKeyEd25519.Ed25519KeyPair.from(verificationMethod)).then(function (key) {
                ...
                try {
                  ...
                  return Promise.resolve(key.toJsonWebKeyPair(false)).then(function (_ref14) {
                    ...
                    var _temp11 = _catch(function () {
                      return Promise.resolve(didKeyEd25519.EdDSA.verifyDetached(signature, data, publicKeyJwk)).then(function (_EdDSA$verifyDetached2) {
...
Object.keys(didKeyEd25519).forEach(function (k) {
  if (k !== 'default') Object.defineProperty(exports, k, {
    enumerable: true,
    get: function () {
      return didKeyEd25519[k];
    }
  });
});
